...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        ...
        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            Las "Combinaciones" representan la unión de todos los elementos anteriores (Parte superior, Fundas, Bases y Medidas) para formar un producto completo y personalizado. Estas combinaciones permiten a los clientes seleccionar configuraciones específicas que mejor se adapten a sus necesidades y preferencias.
        </p>
